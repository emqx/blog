...
">
    ...
    <a href="https://www.emqx.com/en/resources/a-practical-guide-to-mqtt-broker-selection?utm_campaign=embedded-a-practical-guide-to-mqtt-broker-selection&from=blog-micro-python-mqtt-tutorial-based-on-raspberry-pi" class="button is-gradient">Get the eBook →</a>
  </div>
</section>
