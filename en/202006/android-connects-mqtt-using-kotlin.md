...
Kotlin is also a language promoted by Google, and we can develop more interesting applications by using the MQTT protocol and [MQTT cloud service](https://cloud.emqx.io).
