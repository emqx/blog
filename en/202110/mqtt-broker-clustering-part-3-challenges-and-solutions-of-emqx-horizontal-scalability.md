...
Before we start, you should know how data is replicated in the EMQX cluster: [EMQX Broker](https://github.com/emqx/emqx) stores the runtime information about the topics and clients in [Mnesia](https://erlang.org/doc/man/mnesia.html) database, which helps replicate this data across the cluster.
