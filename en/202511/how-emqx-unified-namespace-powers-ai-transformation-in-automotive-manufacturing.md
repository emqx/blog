...
However, there is another more common way to access AI capabilities in production. After collecting raw data, EMQX Neuron cleans, structures, and contextualizes this information before securely publishing it to the central EMQX [MQTT broker](https://www.emqx.com/en/blog/the-ultimate-guide-to-mqtt-broker-comparison). This process is critical. Instead of messy and raw data from multiple Neurons, the AI models receive a perfectly structured feed of information through the UNS. It’s just like a "single source of truth." This has unlocked several AI-related advances that were previously impossible:
