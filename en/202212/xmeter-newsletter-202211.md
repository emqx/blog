The XMeter team continues to focus on the development of XMeter Cloud Professional Edition in November. XMeter Cloud Professional Edition will go live next month, and it will be able to provide more robust support for users who need to test [MQTT](https://www.emqx.com/en/blog/the-easiest-guide-to-getting-started-with-mqtt) on a large scale. please stay tuned.
