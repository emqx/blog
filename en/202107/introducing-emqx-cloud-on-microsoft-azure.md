...
100% MQTT compliant. Supports MQTT v3.1, v3.1.1, and v5.0 as well as other protocols such as [MQTT over WebSocket](https://www.emqx.com/en/blog/connect-to-mqtt-broker-with-websocket), COAP, LwM2M, [MQTT-SN](https://www.emqx.com/en/blog/connecting-mqtt-sn-devices-using-emqx), etc.
