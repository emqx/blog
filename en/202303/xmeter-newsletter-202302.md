XMeter Cloud professional edition, launched in late 2022, has attracted numerous users who are putting its [MQTT](https://www.emqx.com/en/blog/the-easiest-guide-to-getting-started-with-mqtt) concurrent connection and message throughput scenarios to the test at scales ranging from thousands to tens of thousands. We have been delighted to receive their feedback, which has prompted us to expand our support for other [IoT protocols](https://www.emqx.com/en/blog/iot-protocols-mqtt-coap-lwm2m) in the near future.
