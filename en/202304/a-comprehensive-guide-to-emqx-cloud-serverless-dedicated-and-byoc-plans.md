...
| **Customization** | Relatively low level of customization. Suitable for general use cases. Supports the standard [MQTT protocol](https://www.emqx.com/en/blog/the-easiest-guide-to-getting-started-with-mqtt). | Highly customizable, suitable for enterprise-level projects with special requirements. | Allows choosing cloud provider and infrastructure, higher customization level, suitable for projects with special requirements |
