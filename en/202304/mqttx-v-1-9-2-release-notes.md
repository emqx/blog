...
7. Added default values for [subscription options](https://www.emqx.com/en/blog/an-introduction-to-subscription-options-in-mqtt) when using [MQTT 5.0](https://www.emqx.com/en/blog/introduction-to-mqtt-5) connections, simplifying MQTT 5.0 subscription operations and enhancing user experience.
