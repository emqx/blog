...
| 3   | Three million concurrent instant connection                            | Three million [MQTT clients](https://www.emqx.com/en/blog/mqtt-client-tools) simultaneously initiate a connection, and test the time required for the completion of all connections.                                                                                                                                                                                                                                                                | With three million clients connected successfully, the cluster would not avalanche.                                                                                                                                                           |
