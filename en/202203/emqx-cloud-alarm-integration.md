...
| Connections with non-standard [MQTT protocol](https://www.emqx.com/en/blog/the-easiest-guide-to-getting-started-with-mqtt) connections | warning   | There are a large number of client connections with non-standard MQTT protocol | Check whether the MQTT protocol used by the client connection is the standard MQTT protocol |
