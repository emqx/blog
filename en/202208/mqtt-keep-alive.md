...
zone.${zoneName}.server_keepaliveserver_keepalive Type Default Value Integer None
```
...
zone.${zoneName}.keepalive_backoffkeepalive_backoff Type Default Floating point 0.75
```
