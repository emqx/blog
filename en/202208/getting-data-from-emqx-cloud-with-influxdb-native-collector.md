...
While we've used an explicit topic name here, InfluxDB Cloud Native Collector do support wildcards like "+" and "#". Using wildcards is more practical in real use cases. Check [InfluxDB Cloud’s doc](https://docs.influxdata.com/influxdb/cloud/write-data/no-code/native-subscriptions/#subscribe-to-an-mqtt-topic) for more information.
