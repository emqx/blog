...
react_native_mqtt is an [MQTT client](https://www.emqx.com/en/blog/mqtt-client-tools) module used for the React Native project, which supports iOS and Android.
...
">
    ...
    <a href="https://www.emqx.com/en/resources/a-practical-guide-to-mqtt-broker-selection?utm_campaign=embedded-a-practical-guide-to-mqtt-broker-selection&from=blog-how-to-use-mqtt-in-react-native" class="button is-gradient">Get the eBook →</a>
  </div>
</section>
