...
This benchmark testing simulates 100,000 [MQTT clients](https://www.emqx.com/en/blog/mqtt-client-tools) connecting to EMQX, with a connection rate of 5,000 per second. After all connections are established, each client publishes one QoS 1 message with the payload of 200 bytes per second, and all messages, via the rule engine, are written into PostgreSQL. 
