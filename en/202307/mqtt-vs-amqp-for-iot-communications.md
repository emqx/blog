...
| Main Protocol Versions  | · [0.9.1](https://www.rabbitmq.com/resources/specs/amqp0-9-1.pdf) released in November 2008<br>· [1.0](https://docs.oasis-open.org/amqp/core/v1.0/os/amqp-core-overview-v1.0-os.html) released in October 2012 | · [3.1.1](https://docs.oasis-open.org/mqtt/mqtt/v3.1.1/mqtt-v3.1.1.pdf) released in December 2015<br>· [5.0](https://docs.oasis-open.org/mqtt/mqtt/v5.0/mqtt-v5.0.pdf) released in March 2019 |
| **Messaging Paradigms** |                                                              |                                                              |
