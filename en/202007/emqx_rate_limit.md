Before reading this guide, we assume that you have known simple [MQTT](https://www.emqx.com/en/mqtt-guide) and [MQTT broker](https://www.emqx.com/en/products/emqx).
