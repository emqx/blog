...
| **Customization** | Offers a relatively low level of customization, appropriate for general use cases and supports the standard [MQTT protocol](https://www.emqx.com/en/blog/the-easiest-guide-to-getting-started-with-mqtt). | Highly customizable to meet the special requirements of enterprise-level projects. | Allows high levels of customization by choosing cloud provider and infrastructure, suitable for projects with unique requirements. |
