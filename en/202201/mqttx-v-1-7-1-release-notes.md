[MQTTX](https://mqttx.app/) is a fully open-source cross-platform [MQTT](https://www.emqx.com/en/blog/the-easiest-guide-to-getting-started-with-mqtt) 5.0 desktop client open-sourced by [EMQ](https://www.emqx.com/en), It supports macOS, Linux, and Windows systems. Makes it easy and quick to create multiple simultaneous online [MQTT client](https://www.emqx.com/en/blog/mqtt-client-tools) connections, test the connection, publish, and subscribe functions of MQTT/TCP, MQTT/TLS, MQTT/WebSocket as well as other [MQTT protocol](https://www.emqx.com/en/mqtt-guide) features.
