...
> About the MQTT protocol: [https://www.emqx.io/mqtt](https://www.emqx.io/mqtt)
...
Connect the [MQTT client - MQTT X](https://mqttx.app/) to your EMQ X Broker and subscribe to the topic `coap_to_mqtt` for it.
