...
- **Private deployment**
  ...
  [EMQX](https://www.emqx.io/) is the most scalable open-source MQTT broker for IoT, IIoT, and connected vehicles. To install EMQX, run the following Docker command:
