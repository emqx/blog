...
![JMeter thread group](https://static.emqx.net/images/f264fc760b67b75f0f2e912d593afc8e.png)
...
![JMeter TCP Sampler](https://static.emqx.net/images/1e2ce5cddd88ec451fc8552a4430a5d6.png)
...
![JMeter HTTP Request sampler](https://static.emqx.net/images/fc003b6a29ab67435d4ad0d4c7434388.png)
...
![JMeter Add a transaction](https://static.emqx.net/images/82e32714189c1d56c90c7705cad91d3a.png)
...
1. Generate parent sample
   ...
   ![JMeter Generate parent sample](https://static.emqx.net/images/c400e4b3374cf8fc57865be65425c944.png)

   For example, the unchecked summary report is as follows:

   ![JMeter Generate parent sample 2](https://static.emqx.net/images/0bba98959f7eb448d5c1d55408fff9f0.png)

   If checked, the summary report is as follows:

   ![JMeter Generate parent sample 3](https://static.emqx.net/images/5c091921f0daa710ce40116bae8995e1.png)
...
![JMeter Add a once-only controller](https://static.emqx.net/images/52e2a8b76ab101dd7ce789f379e36bd4.png)
...
![JMeter Add a once-only controller 2](https://static.emqx.net/images/ceafc74e7947284a5e64d38948c93de7.png)
...
![JMeter View Results Tree](https://static.emqx.net/images/ed6ffe8187537303ccf4c147ebda722f.png)
...
![JMeter User Defined Variables](https://static.emqx.net/images/3b4b9160e9925fbb992f9a275f876b3f.png)
...
![JMeter test plan](https://static.emqx.net/images/51b6d8f098b65757fe2418322315526d.png)

![JMeter HTTP Request](https://static.emqx.net/images/43676402106a824e28d623d69f9d11e0.png)

For example, a defined variable is referenced in an HTTP request:

![JMeter HTTP Request2](https://static.emqx.net/images/0783a9d22bbaf0bb916587c6c1a6867a.png)

Viewing the execution results, you can see that the value of the variable has been obtained:

![JMeter HTTP Request results](https://static.emqx.net/images/3bafcfcc7dd24d36fb70eac5c42eb33c.png)
...
![JMeter CSV Data Set Config](https://static.emqx.net/images/f60ec142f6e45dc87c275ddb097ccdbd.png)
...
![JMeter JSON Assertion](https://static.emqx.net/images/8be0a773cd6e8175f7cee3b97cedc43c.png)
...
![JMeter JSON Assertion 2](https://static.emqx.net/images/6071d028eedca11b81b4ccedad804e8a.png)

Run the script, check the results, you can see that the assertion is passed.

![JMeter JSON Assertion 3](https://static.emqx.net/images/cccad6019202b8ee3a5dde358727d9bc.png)
...
![JMeter JSON Assertion 4](https://static.emqx.net/images/fb48b8102c6a91a80c0ca4927329fff1.png)

Run the script, check the results, and you can see that the assertion failed

![JMeter JSON Assertion 5](https://static.emqx.net/images/583efaef5c4fb6982e71a6dfd6343897.png)
...
![JMeter Constant Timer](https://static.emqx.net/images/7c69a299ebc3a5901dc6683a1ae459f3.png)

After configuring the thread delay to 100 and 1000 respectively, run the script:

![JMeter Constant Timer 2](https://static.emqx.net/images/1d1da9615cc37eaeb19fe6827c763a18.png)
...
![JMeter Constant Timer 3](https://static.emqx.net/images/a3a61ca13267eb6406dd29e6ee14b7bc.png)
...
![JMeter Constant Throughput Timer](https://static.emqx.net/images/bca182fb1c05b896870d3189484fc7c4.png)
...
![JMeter Constant Throughput Timer 2](https://static.emqx.net/images/100eb43b3f3263a58c46a2d61d39b94e.png)

Run the script, check the results, and you can see that the throughput is approximately 2/second (120/60)

![JMeter Constant Throughput Timer 3](https://static.emqx.net/images/05b4e840a60bf893ed0fc4b426e59b0f.png)
