...
- **增强现有驱动插件能力：**IEC60850-5-104 协议驱动现在支持遥测和时钟同步，为用户提供更强大的设备同步控制能力。[MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 提供可配置的 QoS 和自定义主题订阅以进行组订阅，进一步增加了协议的灵活性。
