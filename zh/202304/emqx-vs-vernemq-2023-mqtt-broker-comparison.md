...
[EMQX](https://github.com/emqx/emqx) 和 [VerneMQ](https://vernemq.com/) 都是用 Erlang/OTP 开发的高性能、分布式开源 [MQTT Broker](https://www.emqx.com/zh/blog/the-ultimate-guide-to-mqtt-broker-comparison)，以其稳定性、容错性和扩展性著称。

EMQX 是目前全球最受欢迎的 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) Broker 之一，而 VerneMQ 项目近年来却没有积极地开发和维护。
...
EMQX 支持多个协议网关，包括 [LwM2M](https://www.emqx.com/zh/blog/iot-protocols-mqtt-coap-lwm2m)/[CoAP](https://www.emqx.com/zh/blog/coap-protocol)、MQTT-SN 和 Stomp。EMQX 5.0 引领了 MQTT over [QUIC](https://www.emqx.com/zh/blog/quic-protocol-the-features-use-cases-and-impact-for-iot-iov) 技术，MQTT over QUIC 通过多路复用、更快的连接建立和迁移等特性，有望成为下一代 MQTT 标准。
