...
EMQ 提供的工业协议网关软件 [Neuron](https://www.emqx.com/zh/products/emqx-neuron) 专为工业数据运营和数据驱动的自动化而设计，能够与业界领先的 [EMQX MQTT Broker](https://www.emqx.com/zh/products/emqx) 紧密集成。Neuron 为智能制造带来了多方面的优势，它可以简化连接，加强数据集成，并支持实时通信和分析。
