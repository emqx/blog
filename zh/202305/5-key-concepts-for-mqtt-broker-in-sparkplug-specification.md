...
- 轻量级：[MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 是一种轻量级协议，占用极少的网络带宽，非常适合低带宽环境。
...
在 Sparkplug 规范中，[MQTT Broker](https://www.emqx.com/zh/blog/the-ultimate-guide-to-mqtt-broker-comparison) 是实现上述 5 个概念不可或缺的组件。
