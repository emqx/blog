...
- EMQX 稳定承载大规模的 [MQTT 客户端](https://www.emqx.com/zh/blog/mqtt-client-tools)连接，单服务器节点支持 50 万到 100 万连接。并且支持分布式节点集群，快速低延时的消息路由，单集群支持 1000 万规模的路由。
- EMQX 支持完整[物联网协议](https://www.emqx.com/zh/blog/iot-protocols-mqtt-coap-lwm2m)，[MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt)、MQTT-SN、[CoAP](https://www.emqx.com/zh/blog/coap-protocol)、LwM2M、WebSocket 和私有协议。
