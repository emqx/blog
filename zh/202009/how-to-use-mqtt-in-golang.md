...
本文主要介绍如何在 Golang 项目中使用 **paho.mqtt.golang** 客户端库 ，实现客户端与 [MQTT 服务器](https://www.emqx.io/cn/products/broker) 的连接、订阅、收发消息等功能。
...
至此，我们完成了使用 **paho.mqtt.golang** 客户端连接到 [公共 MQTT 服务器](https://www.emqx.io/cn/mqtt/public-mqtt5-broker)，并实现了测试客户端与 MQTT 服务器的连接、消息发布和订阅。
