...
​            ![img](assets/0-20200905162154312.png)            
...
注意：如果测试失败，请检查是否完成对等连接，详情请看 [VPC 对等连接](https://docs.emqx.io/cloud/latest/cn/deployments/vpc_peering.html)，并检查 URL 是否正确。
...
####             ![img](https://static.emqx.net/images/8e6648cd122bcaad45d73993b04bedaa.png)            6.4 测试

如果您是第一次使用 EMQ X Cloud 可以前往[部署连接指南](https://docs.emqx.io/cloud/latest/cn/deployments/connections.html)，查看 MQTT 客户端连接和测试指南
