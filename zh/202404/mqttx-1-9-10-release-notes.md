...
MQTTX 1.9.10 版本通过引入 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 5.0 的原因码，使得对连接断开或订阅失败的原因有了更清晰的反馈。这一改进使得用户能够更精确地识别问题，尤其是在处理诸如订阅 ACL 拒绝或服务器主动断开连接等情况时。
