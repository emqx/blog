...
3. [MQTTX](https://mqttx.app/zh)，[MQTT 客户端](https://www.emqx.com/zh/blog/mqtt-client-tools)工具，用于向 ESP32 发送 LED 指令和接收 LED 状态。

[EMQX Cloud](https://www.emqx.com/zh/cloud) Serverless 和 MQTTX 的部署非常简单，这里不再赘述，ESP-IDF 推荐以 IDE 扩展的方式安装，大致的安装步骤为：
...
最后，再次推荐将 EMQX Cloud Serverless 作为您构建应用时的首选 [MQTT Server](https://www.emqx.com/zh/blog/the-ultimate-guide-to-mqtt-broker-comparison)，它的极速部署、可观的免费额度以及自动伸缩等特性，可以极大减少您需要在 MQTT Server 上投入的运维精力，使您可以尽可能地专注在应用的开发工作上。
