...
[MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 协议标准中规定 Broker 必须存储离线客户端的消息。在之前的版本中，[EMQX 开源版](https://github.com/emqx/emqx)采用了基于内存的会话存储，企业版则在此基础上进一步提供了外部数据库存储方案，借此实现数据持久化。
