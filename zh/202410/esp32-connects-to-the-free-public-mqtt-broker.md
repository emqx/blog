...
接下来，我们将安装 [MQTT 客户端](https://www.emqx.com/zh/blog/mqtt-client-tools)库 PubSubClient。PubSubClient 由 Nick O'Leary 开发，是一个为 Arduino 项目设计的轻量级 [MQTT 客户端库](https://www.emqx.com/zh/mqtt-client-sdk)。它为支持 MQTT 的服务器提供了简单的发布/订阅消息传递客户端。该库简化了 MQTT 通信，并实现了 Arduino 基于物联网应用的高效数据交换。
