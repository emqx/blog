配置管理是 IIoT 系统中不可或缺的组成部分，能够确保设备的安全性、可靠性和一致性。随着 IIoT 系统的规模和复杂性不断增加，配置管理的重要性愈加凸显。企业可以通过自动化、集中化的配置管理系统，优化设备管理，简化运维流程，提升管理效率，增强系统的灵活性和扩展性，并确保符合各类法规要求，最终实现更高效的[工业物联网](https://www.emqx.com/zh/blog/iiot-explained-examples-technologies-benefits-and-challenges)系统。
...
6、回到边缘服务列表页面，点击 test1 边缘服务的「详情」按钮，可看到刚下发的配置已经生效，创建了一个名为 test1 的 [OPC UA](https://www.emqx.com/zh/blog/opc-ua-protocol) 设备。
