...
- 将消息重新发布到 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 主题
- 输出到控制台
...
对于不使用 [MQTT 客户端](https://www.emqx.com/zh/blog/mqtt-client-tools)的用户，可以通过测试界面右侧面板输入模拟测试数据。这种方法虽然能够进行模拟测试，但由于可能存在配置限制，无法完全再现真实场景。
