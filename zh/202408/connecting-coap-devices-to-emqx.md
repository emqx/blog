...
[CoAP](https://www.emqx.com/en/blog/coap-protocol) 协议是一种支持在低功耗、低功率等受限设备间进行通信的[物联网协议](https://www.emqx.com/zh/blog/iot-protocols-mqtt-coap-lwm2m)。这些设备往往都运行在受限网络中，因此 CoAP 协议设计得十分精炼，并采用 UDP 协议进行数据传输，能够很好的适应受限网络环境。 CoAP 通过类似于 HTTP 操作的方式，对设备上抽象的资源进行操作，这样能够十分简洁、高效地实现受限设备间同步、 异步的信息交流。
