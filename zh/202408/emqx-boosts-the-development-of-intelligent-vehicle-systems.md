...
事实上，我们发现很多比亚迪车主及开发者利用 [EMQX Serverless](https://www.emqx.com/zh/cloud/serverless-mqtt) 满足智能车机系统中的实时数据传输需求，从而构建其个性化的智能车机系统应用。**本文将从比亚迪开放式的车机系统切入，分享 EMQX Serverless 作为全托管 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 消息服务的领导者，如何为智能车机系统的优化和升级提供效率更高、扩展性更强、成本更低的方式，安全、可靠地支持着车联网设备和应用之间的无缝通信。**
