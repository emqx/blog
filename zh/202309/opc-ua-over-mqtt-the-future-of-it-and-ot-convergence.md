...
[EMQX](https://www.emqx.com/zh/products/emqx) MQTT Broker 和 [Neuron](https://www.emqx.com/zh/products/emqx-neuron) 网关可以完美地支持 OPC UA over MQTT 协议。EMQX 作为一个 MQTT Broker，在消息传输方面表现出色，并具备高效的数据分发能力。而 Neuron 专注于将 OPC UA 与 MQTT 桥接，让您能够充分利用这两种协议的优势。
