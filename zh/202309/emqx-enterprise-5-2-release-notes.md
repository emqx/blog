...
[Sparkplug](https://www.eclipse.org/tahu/spec/sparkplug_spec.pdf) 是[工业物联网](https://www.emqx.com/zh/blog/iiot-explained-examples-technologies-benefits-and-challenges)领域热门的一个开源规范，它基于 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 提供的一套明确定义的 Payload 和状态管理体系，实现了互操作性和一致性。
...
- 修复了在发送带有非零 `ack_flag` 的 [CONNACK](https://www.emqx.com/zh/blog/mqtt5-new-features-reason-code-and-ack) 数据包时 `packets_connack_sent` 指标未增加的问题。[#11520](https://github.com/emqx/emqx/pull/11520)
