...
HBMQTT 是基于 Python 编写的开源库，实现了 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 3.1.1 协议，特性如下：
...
下面我们将演示如何使用 [Python MQTT](https://www.emqx.com/zh/blog/how-to-use-mqtt-in-python) 异步框架 - HBMQTT，轻松实现一个具备 MQTT 发布、订阅功能的异步 Demo。
...
首先，导入 [MQTT 客户端](https://www.emqx.com/zh/blog/mqtt-client-tools)库。
...
至此，我们完成了 HBMQTT 库连接到[公共 MQTT 服务器](https://www.emqx.com/zh/mqtt/public-mqtt5-broker)，并实现了测试客户端与 [MQTT 服务器](https://www.emqx.com/zh/blog/the-ultimate-guide-to-mqtt-broker-comparison)的连接、消息发布和订阅。通过使用 Python 异步 IO 执行消息的发送接收，可以帮助我们实现更加高效的 MQTT 客户端。
