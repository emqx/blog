...
[NeuronEX](https://www.emqx.com/zh/products/emqx-neuron) 是一款专为工业场景设计的边缘网关软件，具备工业设备数据采集、工业各系统数据集成、边端数据过滤分析、AI 算法集成以及数据转发和平台对接等功能，能够为工业场景提供低延迟的数据接入管理及智能分析服务，帮助用户快速洞悉业务趋势，提升运营效率和业务可持续性。
...
在开始自定义函数之前，需要创建一个数据源，作为输入流入。以 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 类型的数据源作为示例，操作步骤如下：
