随着[工业物联网](https://www.emqx.com/zh/blog/iiot-explained-examples-technologies-benefits-and-challenges)（IIoT）领域的快速发展，工业现场的设备数量激增，对实时性、可靠性的要求相应提高，传统的集中式管理方式已难以满足工业物联网的部署与维护需求。如何保障大规模设备接入和配置的一致性、可靠性，成为工业自动化与智能化建设的关键。
