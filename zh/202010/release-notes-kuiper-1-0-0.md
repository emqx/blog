...
Kuiper 1.0.0 [可以从这里下载](https://github.com/lf-edge/ekuiper/releases/tag/1.0.0)。
...
Kuiper 1.0.0 是第一个稳定的主版本。该版本与 EMQ 其它边缘软件进行了完整的集成，包括 [Neuron](https://www.emqx.com/zh/products/emqx-neuron)， [Edge](https://www.emqx.com/zh/products/emqx) 和 边缘管理控制平台 (Edge Manager)。读者可以参考  [edge-stack 项目](https://github.com/emqx/edge-stack) 来获取 EMQ 边缘解决方案的信息。
...
- 增强 TDengine 插件
  ...
  - [TDengine 存储数据的时候允许用户控制时间戳字段](https://github.com/lf-edge/ekuiper/issues/520)
  - [TDengine  插件缺省值的设置](https://github.com/lf-edge/ekuiper/issues/527) 
- 运行在插件安装的脚本中传递参数，这可以让插件的安装过程更灵活
- Rest 服务返回多语言支持
- 修复了以下的问题
  - [日志文件中的行号不正确](https://github.com/lf-edge/ekuiper/issues/518)
