...
本文主要介绍如何在 React 项目中使用 [MQTT](https://www.emqx.com/zh/mqtt-guide)，实现客户端与 [MQTT 服务器](https://www.emqx.com/zh/blog/the-ultimate-guide-to-mqtt-broker-comparison)的连接、订阅、收发消息、取消订阅等功能。
...
因为 React 是一款 JavaScript 库，因此可以使用 [MQTT.js](https://www.emqx.com/zh/blog/mqtt-js-tutorial) 作为 [MQTT 客户端](https://www.emqx.com/zh/blog/mqtt-client-tools)库。
...
综上所述，我们实现了在 React 项目中创建 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 连接，模拟了客户端与 MQTT 服务器进行订阅、收发消息、取消订阅以及断开连接的场景。
