...
EMQX Platform (以下简称 EMQX) 是由 EMQ 提供的一个企业级 MQTT 物联网接入平台，专为大规模部署和物联网应用中的高可靠性而设计，适用于车联网、[工业物联网](https://www.emqx.com/zh/blog/iiot-explained-examples-technologies-benefits-and-challenges)和 AIoT 等复杂场景。EMQX 通过以下关键能力帮助企业实现高效数据接入和管理：
...
- **MQTT over [QUIC](https://www.emqx.com/zh/blog/quic-protocol-the-features-use-cases-and-impact-for-iot-iov) 负载均衡**：通过引入创新性的 [MQTT over QUIC](https://www.emqx.com/zh/blog/mqtt-over-quic)，实现高可靠、低延迟的连接，适用于车联网等网络环境复杂、传输需求高的场景。
