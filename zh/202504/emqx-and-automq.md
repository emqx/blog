...
为了应对这些挑战，吉利汽车的车联网系统采用混合云架构构建。其中汽车远程服务平台（Telematics Service Platform：TSP）位于公有云环境，采用 EMQX 企业级 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 平台，为车联网提供高性能连接与数据集成解决方案。凭借 EMQX 的高性能、高可靠和可伸缩性设计，吉利汽车能够可靠地实时移动和处理车联网数据，帮助用户解决链接和数据基础设施层面的挑战，开发团队可以专注上层应用的开发。
