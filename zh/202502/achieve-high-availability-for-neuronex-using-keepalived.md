...
[NeuronEX](https://www.emqx.com/zh/products/emqx-neuron) 是一款部署在工业边缘的实时数采和智能分析软件，能够实现工业设备协议采集、工业各系统数据集成、边端数据过滤分析、AI 算法集成以及数据转发和平台对接等功能，为工业场景提供低延迟的数据接入管理及智能分析服务。
