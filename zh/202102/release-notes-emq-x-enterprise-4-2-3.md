...
2. 平台侧：EMQX GB/T 32960 网关将报文解码后在 EMQX 内部转为 [MQTT 协议](https://www.emqx.com/zh/mqtt-guide)进行数据上下行操作：
   - 数据上行：将上行数据报文以 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) PUBLISH 的形式发布到特定的主题上；
