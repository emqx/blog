一月，我们主要专注于月底发布的 Neuron2.0-alpha.2。这个版本主要增加了 [Neuron](https://www.emqx.com/en/products/emqx-neuron) 的持久化功能，支持网页端的导入和导出，增加了压力测试的流程，支持分离的商业化模块，并解决了 alpha.1 中发现的问题。
...
这一新增功能极大减少了 [OPC UA](https://www.emqx.com/zh/blog/opc-ua-protocol) 设备数据变化时产生的数据带宽消耗。
