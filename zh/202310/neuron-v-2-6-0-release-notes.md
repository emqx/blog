近日，EMQ 旗下的工业协议网关软件 [Neuron](https://www.emqx.com/zh/products/emqx-neuron) 发布了最新的 2.6.0 版本。
...
[SECS GEM HSMS 驱动使用说明文档](https://docs.emqx.com/zh/neuronex/latest/)
...
[KUKA Ethernet KRL TCP 驱动使用说明文档](https://docs.emqx.com/zh/neuronex/latest/)
...
Mitsubishi 3E、Beckhoff ADS、Modbus TCP、Modbus RTU、Siemens S7 ISOTCP、Omron FINS TCP、[OPC UA](https://www.emqx.com/zh/blog/opc-ua-protocol)、BACnet/IP 插件支持 HTTP API一次写入多个标签。
...
- [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 插件支持离线数据上报频率控制；
