...
1. 在规则引擎消息重发布规则动作中，支持设置 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 5.0 发布属性与用户属性，以便实现更灵活的消息转发处理。该功能目前仅提供了 REST API，将在后续版本开发 Dashboard 的支持。
