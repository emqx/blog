...
OMH 借助 [MQTT Broker](https://www.emqx.com/zh/blog/the-ultimate-guide-to-mqtt-broker-comparison) EMQX 提供了标准化的数据访问方式。这使得授权的用户和应用能够使用一致且明确的 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 接口来订阅来自自动化金字塔中任何信息系统的数据。此外，OMH 还通过 Neuron 网关提供了标准化的设备数据采集方式，使不同格式的设备数据能够与任何其他系统或设备进行通信。
