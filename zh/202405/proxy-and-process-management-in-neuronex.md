[NeuronEX](https://www.emqx.com/zh/products/emqx-neuron) 是一款工业边缘网关软件，提供工业多协议接入与边缘计算能力。它主要部署在工业现场，用于工业设备通信、工业总线协议采集、数据集成、边端数据过滤分析、AI 算法集成以及工业互联网平台对接，为工业场景提供低延迟的数据接入管理及智能分析服务。
