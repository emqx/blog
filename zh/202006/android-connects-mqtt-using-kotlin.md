...
本文将使用 EMQ X  [MQTT Cloud](https://cloud.emqx.io/) 运营和维护的免费公共 [MQTT 服务器](https://www.emqx.cn/products/broker)， EMQ X Cloud 是由 [EMQ](https://www.emqx.cn/) 推出的安全的 MQTT 物联网云服务平台，它提供一站式运维代管、独有隔离环境的 **MQTT 5.0** 接入服务。
...
而 Kotlin 也是 Google 官方主推的一门语言，结合 MQTT 协议及 [MQTT 云服务](https://cloud.emqx.io/)，我们可以开发更多有趣的应用。
