...
Kuiper 0.4.1 [可以从这里下载](https://github.com/lf-edge/ekuiper/releases/tag/0.4.1)。
...
- [http_pull 源](https://github.com/lf-edge/ekuiper/blob/develop/docs/zh_CN/rules/sources/http_pull.md)支持，可以定时从 HTTP rest 接口中拉取数据

### 感谢

@worldmaomao 提供了[浮点](https://github.com/lf-edge/ekuiper/issues/272)运算的修复
