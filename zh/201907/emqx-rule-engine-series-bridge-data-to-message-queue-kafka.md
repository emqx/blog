EMQX 3.2 版本引入了 “规则引擎” 功能，支持在 EMQX Broker 筛选终端上报的数据，处理后流至后端数据库或其他的消息队列。本篇以具体场景来说明 “如何使用规则引擎将消息转发至 Kafka”
...
![WX201907181413252x.png](https://assets.emqx.com/images/50ad603e3d7dbbb8329150a258ed52a6.png)



EMQX 集群中节点所在网络环境可能互不相同，资源创建成功后点击列表中 **状态按钮**，查看各个节点资源连接状况，如果节点上资源不可用，请检查配置是否正确、网络连通性，并点击 **重连** 按钮手动重连。

![image20190716173259015.png](https://assets.emqx.com/images/0c3e21837ebfc3647754cb81c76a4a97.png)
...
![image20190716174727991.png](https://assets.emqx.com/images/b7a87db24b9ffeb0bf029d9e7b6dacad.png)
...
![image20190716184242159.png](https://assets.emqx.com/images/da32fcfeb384105e9a5d3dfbafd26f2d.png)
...
![WX201907181416302x.png](https://assets.emqx.com/images/5d268e9b96c49826e8da92fb51190ba8.png)
...
![image20190716190238252.png](https://assets.emqx.com/images/de0f341922ab7922503177c5b077d5ce.png)
