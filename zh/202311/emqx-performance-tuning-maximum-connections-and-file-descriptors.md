...
以 EMQX 5.3.0 为例，我们可以访问 [Dashboard](https://docs.emqx.com/zh/emqx/latest/guides/dashboard/introduction.html) 的监听器页面，然后点击监听器名字进入相应的配置页面，将 Max Connections 修改为一个小于当前系统限制的值：
