...
除了支持 MQTT 3.1/3.1.1/5.0，同时支持 [LwM2M](https://www.emqx.com/zh/blog/iot-protocols-mqtt-coap-lwm2m)、[CoAP](https://www.emqx.com/zh/blog/coap-protocol)、MQTT-SN 或 TCP/UDP 私有协议接入，支持车载通信单元通过 MQTT 或 JT-808/GBT-32960 车联网专业协议接入，能适应项目中不同的设备协议，实现全量设备统一接入。
