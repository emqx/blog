我们很高兴地告诉大家，[EMQX Enterprise](https://www.emqx.com/zh/products/emqx) 4.4.12 以及 4.4.13 版本正式发布！
...
[MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 作为有状态的长连接接入协议，在生产环境下 EMQX 集群运维不可避免的会遇到一些困难。
...
- 持久会话的 [MQTT 客户端](https://www.emqx.com/zh/blog/mqtt-client-tools)重新连接 EMQX 之后，未确认的 QoS1/QoS2 消息不再周期性重发，该行为符合协议规范。
