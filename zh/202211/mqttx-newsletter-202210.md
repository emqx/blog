十月初，MQTTX 团队发布了 1.8.3 版本。对桌面端应用实现了 MQTT 5.0 版本适配，MQTTX CLI 支持了多主题订阅，同时修复了多个已知问题。此外，团队正专注于 1.9.0 版本的开发，最主要的更新是为 MQTTX CLI 加入了新的命令 – `bench`，即 MQTT 性能测试命令，帮助用户可以创建、订阅和发布自定义数量的连接、主题与消息。安装或更新后即可快速使用，无需额外操作。
