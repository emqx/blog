...
EMQ 旗下[边缘工业协议网关软件 Neuron](https://www.emqx.com/zh/products/emqx-neuron) 提供改进的 [Modbus 协议](https://www.emqx.com/zh/blog/modbus-protocol-the-grandfather-of-iot-communication)，支持每 100 毫秒一次采集数千点位的数据，可以满足储能系统数据高频的数据采集需求。
...
EMQ 提供[企业级物联网 MQTT 接入平台 EMQX](https://www.emqx.com/zh/products/emqx)，基于 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 提供储能系统的连接和双向解耦的消息传递方案，并内置基于规则引擎之上的网闸穿透、数据编码、数据持久化和数据转发的功能，实现储能数据的汇聚和灵活应用。
