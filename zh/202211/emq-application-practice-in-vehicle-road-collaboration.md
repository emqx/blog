...
- **多协议设备接入能力：**除了支持 MQTT 3.1/3.1.1/5.0，同时支持 [LwM2M](https://www.emqx.com/zh/blog/iot-protocols-mqtt-coap-lwm2m)、[CoAP](https://www.emqx.com/zh/blog/coap-protocol)、MQTT-SN 或 TCP/UDP 私有协议接入，支持车载通信单元通过 MQTT 或 JT-808/GBT-32960 车联网专业协议接入，能适应项目中不同的设备协议，实现全量设备统一接入。
...
探索 MQTT over [QUIC](https://www.emqx.com/zh/blog/quic-protocol-the-features-use-cases-and-impact-for-iot-iov) 技术在车路协同系统的应用。QUIC 是下一代互联网协议 HTTP/3 的底层传输协议，致力解决弱网络、频切换、易拥塞等问题。EMQ 正积极推进 MQTT over QUIC 的标准化落地，同时结合 5G 网络探索实现车路协同所需的全场景低时延、高可靠传输。
