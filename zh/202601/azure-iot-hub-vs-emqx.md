...
EMQX 基于 Erlang/OTP Actor 模型构建。每个连接都由一个轻量级进程处理，赋予了 EMQX 极高的并发处理能力和极低的响应延迟。[EMQX Enterprise](https://www.emqx.com/zh/products/emqx) 6.0 进一步引入了基于 RocksDB 的存储引擎，支持在同一集群内实现持久化和异步消息传输。
...
Azure IoT Hub 仅将 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 3.1.1 作为兼容层使用，并非功能完整的 Broker，缺失了许多关键的 MQTT 特性。相比之下，EMQX 原生支持 MQTT 3.1、3.1.1 和 5.0，以及 [CoAP](https://www.emqx.com/zh/blog/coap-protocol)、[LwM2M](https://www.emqx.com/zh/blog/iot-protocols-mqtt-coap-lwm2m) 及 MQTT-SN 等协议。
...
| **MQTT over [QUIC](https://www.emqx.com/zh/blog/quic-protocol-the-features-use-cases-and-impact-for-iot-iov)**          | 不支持             | 原生支持                    | 提升不稳定网络和移动网络下的连接性能               |
