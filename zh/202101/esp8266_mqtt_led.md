...
在此项目中我们将实现 NodeMCU(ESP8266) 与 [EMQX Cloud](https://www.emqx.com/zh/cloud) 运营和维护的免费公共 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 服务器远程控制 LED 灯，并使用 Arduino IDE 来对 NodeMCU ESP8266 进行编程。 EMQX Cloud 是由 EMQ 推出的安全的 [MQTT 物联网云服务平台](https://www.emqx.com/zh/cloud)，它提供一站式运维代管、独有隔离环境的 **MQTT 5.0** 接入服务。
...
3. 设置 WIFI 名称和密码，以及 [MQTT Broker](https://www.emqx.com/zh/blog/the-ultimate-guide-to-mqtt-broker-comparison) 连接地址和端口
