十二月末，MQTTX 团队发布了 1.9.1-beta.1 版本，这也是 MQTTX 的首个公共测试版。我们希望能够通过测试版本，让更多用户参与到 MQTTX 的测试中来，和我们一起打造一个更加稳定的版本，进而帮助用户轻松使用 MQTTX 完成 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 服务与应用的开发。
