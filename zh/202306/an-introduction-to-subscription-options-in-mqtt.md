...
在本文中，我们将重点介绍在 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 中哪些订阅选项可供我们使用，以及它们的使用方法。
...
这个选项通常被用在桥接场景中。桥接本质上是两个 [MQTT Server](https://www.emqx.com/zh/blog/the-ultimate-guide-to-mqtt-broker-comparison) 建立了一个 MQTT 连接，然后相互订阅一些主题，Server 将客户端的消息转发给另一个 Server，而另一个 Server 则可以将消息继续转发给它的客户端。
