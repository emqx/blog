5 月，[EMQX 开源版](https://github.com/emqx/emqx)发布了 v5.0.25、v5.0.26 两个版本，改进了速率限制机制，提升了多个组件的性能与安全性，并修复了已知的错误。
...
1. 提高了 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 数据包处理的性能。
