...
面对未来 3-5 年内设备数量从 10 万台扩展到 50-100 万台的发展需求，该公司亟需将原有的开源 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 消息代理升级为企业级消息基础设施，以满足临床环境对关键任务可靠性、生命数据 QoS 2 保障、本地部署灵活性以及多协议支持的要求。
