...
NeuronEX 工业边缘网关软件具备接入 PLC、数控机床、工业机器人、传感器等多种类型设备的能力，支持 [Modbus](https://www.emqx.com/zh/blog/modbus-protocol-the-grandfather-of-iot-communication)、[OPC UA](https://www.emqx.com/zh/blog/opc-ua-protocol)、IEC 61850 和 IEC 104 等常用工业协议，让使用不同协议的设备数据能够被顺利采集并整合到统一的数据平台。通过注册的工业标识与设备 IP 地址，端口的绑定信息，可批量导入设备，在数据采集端完成标识体系的对接。
