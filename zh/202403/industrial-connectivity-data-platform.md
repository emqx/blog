...
[NeuronEX](https://www.emqx.com/en/products/emqx-neuron) 是一款工业边缘网关软件。它提供设备数据采集和边缘智能分析服务，主要部署于工业现场。NeuronEX 实现了工业设备通信、工业总线协议采集、工业系统数据集成、边端数据过滤分析以及 AI 算法集成等功能，并与工业互联数据平台实现了对接集成。这些功能为工业场景提供了低延迟的数据接入管理及智能分析服务，帮助用户快速洞察业务趋势，从而提升运营效率和可持续性。
