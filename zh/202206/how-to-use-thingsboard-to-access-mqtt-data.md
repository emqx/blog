...
本文将使用 ThingsBoard Cloud 结合 [EMQ](https://www.emqx.com/zh) 旗下的全托管 [MQTT 云服务 - EMQX Cloud](https://www.emqx.com/zh/cloud)，介绍如何在 ThingsBoard 中集成第三方 [MQTT Broker](https://www.emqx.com/zh/blog/the-ultimate-guide-to-mqtt-broker-comparison) 并自定义配置 Dashboard UI 接入 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 数据。
