...
在本次演讲中，杰霖将分享开源软件在量产车辆中成功应用的实践案例，包括健康开源社区带来的核心价值，以及如何通过学术研究填补安全漏洞、提升系统稳定性。演讲还将深入解析软件供应链的关键作用，呈现一套经过失败验证的成熟方案，有效降低基于 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 的远程车辆诊断系统的依赖风险。
...
为充分发挥开源软件在汽车行业的潜力，行业需要系统总结过往经验，规划更具战略性的发展路径。本次演讲融合了三家主流整车厂项目的实战经验，分享了将开源技术应用于量产车辆的全过程，涵盖了 [V2X](https://www.emqx.com/zh/blog/what-is-v2x-and-the-future-of-vehicle-to-everything-connectivity) 车联网信息娱乐系统及车云协同数据闭环平台建设。
