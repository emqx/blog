...
物联网 MQTT 服务器 [EMQ X](https://www.emqx.io/cn/) 提供 [emqx_statsd](https://github.com/emqx/emqx-statsd) 插件，用于将 EMQ X 运行指标及 Erlang 虚拟机状态数据输出到第三方的监控系统如 Prometheus 中。通过 Prometheus 自带的 node-exporter 还可以采集 Linux 服务器相关指标，实现服务器 + EMQ X 整体运维监控。
...
[EMQ X](https://www.emqx.io/cn/) MQTT 服务器通过 Prometheus push gateway 推送指标数据，支持的指标项如下：
