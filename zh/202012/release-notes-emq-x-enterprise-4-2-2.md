...
同时，该版本提高了 [LwM2M](https://www.emqx.com/zh/blog/iot-protocols-mqtt-coap-lwm2m) 协议易用性，可以通过 Dashboard 可视化界面与 REST API 单独管理 LwM2M 连接，包括通过 LwM2M 协议接入 EMQX 的客户端列表以及对应的 Object 和 Resource。
