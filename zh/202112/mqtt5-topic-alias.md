[MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) v5 相较于 MQTT v3.1 和 v3.1.1 提供了许多新特性。我们会尽量以通俗易懂的方式展示这些特性，并探讨这些特性对开发者的影响。我们已经探讨过其中一部分 [MQTT v5 新特性](https://www.emqx.com/zh/blog/introduction-to-mqtt-5)，今天将继续讨论：**主题别名**。
