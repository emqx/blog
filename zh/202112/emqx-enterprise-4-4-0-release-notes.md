...
规则引擎新增对 InfluxDB v2 API 的支持。至此，[EMQX Enterprise](https://www.emqx.com/zh/products/emqx) 规则引擎将同时支持 InfluxDB 1.x 与 2.x 多个版本。在此基础上，我们还提供了对 InfluxDB Cloud 的支持，用户可以方便快捷地选择私有化部署或云服务。
...
- 支持配置是否转发为空的保留消息，以适应仍在使用 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) v3.1 的用户
- 优化内置访问控制文件模块的使用交互
