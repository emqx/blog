[EMQX](https://www.emqx.com/zh/products/emqx) 是基于 Erlang/OTP 平台开发的开源物联网 [MQTT 消息服务器](https://www.emqx.io/zh)，目前广泛应用于全球各行业物联网平台建设中。其设计目标是实现高可靠承载海量物联网终端的 [MQTT](https://www.emqx.com/zh/mqtt-guide) 连接，支持在海量物联网设备间低延时消息路由。
