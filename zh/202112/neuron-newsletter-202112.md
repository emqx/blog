...
- 支持 [MQTT](https://www.emqx.com/zh/mqtt-guide) 连接。用户可以远程通过 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 来控制和配置 Neuron、设置点位，读写neuron连接的设备的数据。
- 支持同时连接多个相同或不同的工业设备。目前已支持 Modbus TCP 和 [OPC UA](https://www.emqx.com/zh/blog/opc-ua-protocol) 协议设备。
