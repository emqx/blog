...
> 注意：由于 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 协议的限制，消息的载荷大小不得超过 256MB。在传输前，请验证你的 [MQTT broker](https://www.emqx.com/zh/blog/the-ultimate-guide-to-mqtt-broker-comparison) 的载荷大小限制。
