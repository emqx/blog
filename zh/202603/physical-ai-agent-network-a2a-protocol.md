...
EMQX 通过基于 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt)（物联网消息事实标准）的事件驱动架构重新设计 A2A 通信，应对上述挑战。EMQX 不是将 A2A 视为一系列 HTTP 请求，而是在 MQTT 的发布-订阅模型上实现该协议，既与物联网环境自然契合，又保持完整的 A2A 协议兼容性。
