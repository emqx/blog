...
| **组件**       | **名称**                                                     |
| -------------- | ------------------------------------------------------------ |
| 边缘数采软件   | [Neuron - 工业协议网关软件](https://www.emqx.com/zh/products/emqx-neuron) |
...
利用 Neuron 将工厂内 PLC、非标自动化设备、SCADA 以及各类仪器仪表通过现场总线方式进行实时数据采集。Neuron 支持 [Modbus](https://www.emqx.com/zh/blog/modbus-protocol-the-grandfather-of-iot-communication)、[OPCUA](https://www.emqx.com/zh/blog/opc-ua-protocol)、 Siemens S7 等 80+ 现场总线协议采集，最高采集频率可到100ms，还支持通过 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 和 Restful API 等方式实现对工厂设备的反向控制功能。
