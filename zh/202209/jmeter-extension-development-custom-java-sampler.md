...
接下来我们将以 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 协议中的连接为例，介绍使用 Java Sampler 来进行扩展开发的具体步骤。
...
上述代码中我们硬编码了 [MQTT Broker](https://www.emqx.com/zh/blog/the-ultimate-guide-to-mqtt-broker-comparison) 的连接信息，但在实际应用场景中，更希望能使用一个 JMeter 插件，连接不同的 MQTT Broker。这种情况下，就可以将连接信息从 `JavaSamplerContext` 的参数中读取出来：
