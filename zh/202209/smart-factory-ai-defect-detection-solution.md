>**导语**
>
>随着工业 4.0 时代的来临，数字化、智能化转型成为工业领域企业保持核心竞争力的必经之路。工业制造涉及环节和场景众多，对于各类生产数据的收集与处理能力是决定其自动化程度的关键。构建可靠的[工业物联网](https://www.emqx.com/zh/blog/iiot-explained-examples-technologies-benefits-and-challenges)数据接入层，为上层平台与应用提供实时可靠的数据源以供分析决策，可以极大提高工作效率。
>
...
| 边缘 Broker    | [NanoMQ](https://nanomq.io/zh) - 超轻量级边缘[MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt)消息服务器  |
