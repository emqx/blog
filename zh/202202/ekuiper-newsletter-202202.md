...
1.4.3 版本主要解决本月发现的一些问题。主要是共用连接在 [MQTT](https://www.emqx.com/zh/blog/the-easiest-guide-to-getting-started-with-mqtt) 和 EdgeX 中的订阅同一个主题导致的问题。我们对共用连接的实现进行了重构，以解决这个问题。另外，我们还修复了预编译的 tdengine 插件运行崩溃的问题。
