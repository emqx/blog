本月，我们为即将于三月初发布 Neuron 2.0-beta.1 版本进行了紧张有序的准备工作。beta.1 版本是一个重要版本，该版本中我们增加了商业版 Modbus TCP 和 [OPC UA](https://www.emqx.com/zh/blog/opc-ua-protocol) 驱动，有完整的持久化功能，并且具备完善的功能测试和压力测试，是第一个经过稳定测试的具有商用模块的版本，也是后续开发的一个基准版本。
