...
[EMQX](https://www.emqx.com/ja/products/emqx) MQTTブローカーと[NeuronEX](https://www.emqx.com/ja/products/emqx-neuron)ゲートウェイは、OPC UA over MQTTを完全に有効にします。EMQXのMQTTブローカーとしての実績は、信頼性の高いメッセージ配信と効率的なデータ配布を保証する一方、NeuronのOPC UAからMQTTへのブリッジングに特化した機能により、両方のプロトコルの強みを活用できます。
