...
今回は、[MQTTX](https://mqttx.app/)が提供するブラウザアクセスをサポートするMQTTクライアントツール「[https://mqttx.app/web-client/」](https://mqttx.app/web-client/)を使用します。MQTTXでは、デスクトップクライアントとコマンドラインツールも提供されています。
...
ブラウザで [https://mqttx.app/web-client/](https://mqttx.app/web-client/)  にアクセスし、ページ中央の `New Connection` ボタンをクリックすると、以下のページが表示されます。
